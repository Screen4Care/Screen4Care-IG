...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ArtifactAssessment">
      ...
      <sch:assert test="count(f:extension[@url = 'https://www.netzwerk-universitaetsmedizin.de/fhir/screen4care/StructureDefinition/ceosys-extension-artifact-assessment-version']) &gt;= 1">extension with URL = 'https://www.netzwerk-universitaetsmedizin.de/fhir/screen4care/StructureDefinition/ceosys-extension-artifact-assessment-version': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://www.netzwerk-universitaetsmedizin.de/fhir/screen4care/StructureDefinition/ceosys-extension-artifact-assessment-version']) &lt;= 1">extension with URL = 'https://www.netzwerk-universitaetsmedizin.de/fhir/screen4care/StructureDefinition/ceosys-extension-artifact-assessment-version': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://www.netzwerk-universitaetsmedizin.de/fhir/screen4care/StructureDefinition/ceosys-extension-artifact-assessment-publication-status']) &gt;= 1">extension with URL = 'https://www.netzwerk-universitaetsmedizin.de/fhir/screen4care/StructureDefinition/ceosys-extension-artifact-assessment-publication-status': minimum cardinality of 'extension' is 1</sch:assert>
